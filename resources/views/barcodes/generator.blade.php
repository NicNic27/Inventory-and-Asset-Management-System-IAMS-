...
<html lang="en">
<head>
    <title>QR Code Master List - Staff</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 no-print title-section">
            <div>
                <h2 style="color: #003366; margin: 0;">
                    <i class="fas fa-qrcode text-primary me-2"></i> QR Code Master List
                </h2>
        ...
        <div class="filter-card no-print">
            <form action="{{ url('/barcodes') }}" method="GET" id="filterForm">
        ...
        <div class="table-card">
            ...
            <div class="d-flex justify-content-between align-items-center border-top pt-3 mt-3 no-print pagination-section">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <form action="{{ url('/barcodes') }}" method="GET" id="perPageForm">
